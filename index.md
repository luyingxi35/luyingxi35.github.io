...
- **Robotics:** Robot learning and Manipulation
    - Generalization across diverse objects and environments
    - Robustness in real-world settings
    - Bridging the gap between simulation and reality
    - Empower robot manipulation with foundation model
- **Multi-modal LLMs:** Reasoning with multi-modal LLMs.

Currently, I am particularly interested in <span style="color:darkred"><strong>robotics</strong></span>, and I have been devoted to <span style="color:darkred"><strong>improving task success rates</strong></span> while<span style="color:darkred"><strong> maintaining strong generalizability</strong></span> through <span style="color:darkred"><strong>sim-to-real post-training</strong></span>.
